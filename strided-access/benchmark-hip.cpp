//
// HIP benchmark for measuring effective memory bandwidth for strided array access
//
...
int main(int argc, char **argv)
{
  ...
  // Warmup calculation:
  hipLaunchKernel(HIP_KERNEL_NAME(elementwise_add), dim3(256), dim3(256), 0, 0, x, y, z,
  ...
  for (std::size_t stride = 0; stride <= 32 ; ++stride)
  {
