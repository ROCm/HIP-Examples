...
RDTimerCPU* rdtimerMallocCpu;
RDTimerCPU* rdtimerC2GCpu;
RDTimerCPU* rdtimerG2CCpu;
RDTimerCPU* rdtimerKernelCpu;
#endif
...
#define __PARSEC_XSTRING(x) __PARSEC_STRING(x)
  ...
  PStream* stream;
  	...
  	float overall_cpu_t;
		...
		rdtimerMallocCpu = new RDTimerCPU();
		rdtimerMallocCpu->Reset("Malloc Time");
		 rdtimerC2GCpu = new RDTimerCPU();
		rdtimerC2GCpu->Reset("CPU to GPU Transfer time");
		 rdtimerG2CCpu = new RDTimerCPU();
		rdtimerG2CCpu->Reset("GPU to CPU Transfer Time");
		 rdtimerKernelCpu = new RDTimerCPU();
		rdtimerKernelCpu->Reset("COMPUTE: Kernel Execution Time");
...
//  printf("time = %lfs\n",t2-t1);
	...
	serializeTime->Serialize(rdtimerMallocCpu);
	serializeTime->Serialize(rdtimerC2GCpu);
	serializeTime->Serialize(rdtimerKernelCpu);
	serializeTime->Serialize(rdtimerG2CCpu);
	serializeTime->Serialize(rdtimerOverallCpu);

	delete rdtimerMallocCpu;
	delete rdtimerC2GCpu;
	delete rdtimerG2CCpu;
	delete rdtimerKernelCpu;
