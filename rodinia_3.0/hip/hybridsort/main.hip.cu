			  ...
			  float *resultList, int numElements)
{
	...
	//printf(" /n New list size = %d ", newlistsize);	
	...
	hipMemcpy((void *) resultList,(void *)mergeresult, numElements * sizeof(float), hipMemcpyDeviceToHost) ;
