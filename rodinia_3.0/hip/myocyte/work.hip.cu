...
#include "kernel_ecc.hip.cu"
#include "kernel_cam.hip.cu"
#include "kernel_fin.hip.cu"
#include "kernel.hip.cu"
#include "master.hip.cu"
#include "embedded_fehlberg_7_8.hip.cu"
#include "solver.hip.cu"
...
int work(	int xmax,
    ...
    myTimer->Stop();
    serializeTime->Serialize(myTimer);
    myTimer->Reset("READ DATA FROM FILES");
    myTimer->Start();
#endif
