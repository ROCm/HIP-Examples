...
#include "kernel_fin_2.hip.cu"
#include "kernel_ecc_2.hip.cu"
#include "kernel_cam_2.hip.cu"
#include "kernel_2.hip.cu"
#include "embedded_fehlberg_7_8_2.hip.cu"
#include "solver_2.hip.cu"
...
int work_2(	int xmax,
    ...
    myTimer->Reset("ALLOCATE CPU MEMORY AND GPU MEMORY");
    myTimer->Start();
#endif
	//================================================================================80
	// 	ALLOCATE MEMORY
    ...
    myTimer->Stop();
    serializeTime->Serialize(myTimer);
    myTimer->Reset("READ DATA FROM FILES, COPY TO GPU MEMORY");
    myTimer->Start();
#endif
	//================================================================================80
    ...
    myTimer->Stop();
    serializeTime->Serialize(myTimer);
    myTimer->Reset("COMPUTE: solver_2");
    myTimer->Start();
#endif
	//================================================================================80
    ...
    myTimer->Stop();
    serializeTime->Serialize(myTimer);
    myTimer->Reset("COPY GPU DATA TO CPU MEMORY");
    myTimer->Start();
#endif
	//================================================================================80
